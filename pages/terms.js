        ...
        <div className="bg-light me-md-3 text-center overflow-hidden">
          <div className="pt-3 px-3 pt-md-5 px-md-5">
            <div className="my-3 py-3">
              <p className="lead">
                Jakub Zientek built the hhiker beta app as a Free app. This
                SERVICE is provided by Jakub Zientek at no cost and is intended
              ...
              <p className="lead">
                ...
                hhiker beta unless otherwise defined in this Privacy Policy.
              </p>{" "}
              <p className="lead">
                Information Collection and Use For a better experience, while
                using our Service, I may require you to provide us with certain
                personally identifiable information, including but not limited
                to email, location. The information that I request will be
              ...
              <p className="lead">
                ...
                Services Log Data I want to inform you that whenever you use my
                Service, in a case of an error in the app I collect data and
                information (through third-party products) on your phone called
              ...
              <p className="lead">
                These are sent to your browser from the websites that you visit
                and are stored on your device&apos;s internal memory. This
                Service does not use these “cookies” explicitly. However, the
              ...
              <p className="lead">
                Security I value your trust in providing us your Personal
                ...
                operated by me. Therefore, I strongly advise you to review the
              ...
              <p className="lead">
                ...
                me so that I will be able to do the necessary actions. Changes
                to This Privacy Policy I may update our Privacy Policy from time
                to time. Thus, you are advised to review this page periodically
                for any changes. I will notify you of any changes by posting the
                new Privacy Policy on this page.
              </p>{" "}
              <p className="lead">
                This policy is effective as of 2021-12-05 Contact Us If you have
                any questions or suggestions about my Privacy Policy, do not
                hesitate to contact me at jakub.zient@gmail.com.
              </p>
            </div>
          </div>
        </div>
        <div className="bg-light me-md-3 text-center overflow-hidden terms"></div>
      </div>
    </main>
  );
};
